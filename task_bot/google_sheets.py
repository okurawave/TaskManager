...
def get_next_task_id(worksheet):
    ...
    try:
        ...
        # For now, let's assume if there's an error, we default to a potentially problematic 1
        # A more robust solution might involve trying to read all data and find max ID
        return 1
